    ...
    try {
      ...
      for (let index = 0; index < questionContainers.length; index++) {
        ...
        try {
          ...
          // Luôn click lại nếu đáp án đúng chưa được chọn (kể cả khi đã từng click trước đó).
          // Điều này giúp Alt+X sửa lại được khi người dùng tự chọn đáp án sai.
          const needsClick = shouldClick && !correctAnswerIsSelected;
